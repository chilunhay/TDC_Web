                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ...
                            {Districts &&
                                pcVN.getDistrictsByProvinceCode(Provinces.selectedId ).map((item) => (
                                    <option key={item.district_code} value={item.district_code} selected={Districts.selectedId === item.district_code}>
                                        {item.name}
                                    </option>
                                ))}
                        </select>
