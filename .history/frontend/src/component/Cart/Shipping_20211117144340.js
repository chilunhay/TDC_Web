...
const Shipping = () => {
    ...
    const onSelectProvince = (provinceCode) => {
        const selDistrict = Districts.filter(c => c.province_code === provinceCode);
        this.setState({
            province_code: provinceCode,
            Districts: selDistrict,
        });
    };

    const onSelectDistrict = (districtCode) => {
        this.setState({
            Districts: districtCode.district_code,
        });
    }
                ...
                >
                            ...
                            {Provinces &&
                                Provinces.map((prov) => (
                                    <option 
                                        ...
                                        //selected={Provinces === prov.provinceCode}
                    ...
                    <div>
                        ...
                        >
                            ...
                            {Districts &&
                                Districts.getDistrictsByProvinceCode(provinceCode).map((dist) => (
                                    <option 
                                        key={dist.districtCode} 
                                        value={dist.districtCode}
                                        //selected={Districts.selectedId === dist.districtCode}
