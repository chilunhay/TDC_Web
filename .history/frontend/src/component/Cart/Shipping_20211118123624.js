...
const Shipping = ({ history }) => {
    ...
    class Province extends React.Component {
        onSelect = (event) => {
            this.props.onSelect(setProvince(event.target.value));
        }
        render() {
            return (
                <div>
                    ...
                    <select required
                        value={province}
                        //onClick={(event) => {setProvince(event.target.value)}}
    ...
    class City extends React.Component {
        onSelect = (event) => {
            this.props.onSelect(setDistrict(event.target.value));
        }
        render() {
            return (
