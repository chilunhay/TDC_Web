                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ...
                            {Provinces &&
                                Provinces.map((item) => (
                                    <option key={item.province_code} value={item.province_code} selected={Provinces.selectedId === item.province_code}>
                                        {item.name}
                                    </option>
                                ))}
                        </select>
                    ...
                    <div>
                        ...
                        >
                            ...
                            {pcVN.getDistrictsByProvinceCode(chooseProvince) &&
                                pcVN.getDistrictsByProvinceCode(chooseProvince).map((item) => (
                                    <option key={item.district_code} value={item.district_code} selected={Provinces.selectedId === item.province_code}>
                                        {item.name}
                                    </option>
                                ))}
                        </select>
