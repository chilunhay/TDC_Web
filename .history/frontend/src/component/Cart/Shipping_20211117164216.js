...
const Shipping = () => {
    ...
    const handleSelectProvince = (name, id) => {
        ...
        pcVN.getDistrictsByProvinceCode(id);
    };
                    ...
                    {chooseProvince && (
                        <div>
                            ...
                            <select
                                ...
                                onClick={chooseDistrict.name}
                                
                            >
                                <option value="">Quận/ Huyện</option>
                                {Districts &&
                                    pcVN.handleSelectProvince("01").map((item) => (
                                        <option key={item.district_code} value={item.district_code} 
                                        onClick={() =>
                                        handleSelectDistrict(item.name,item.district_code)
                                }
                                        >
                                            {item.name}
                                        </option>
